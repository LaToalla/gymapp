...
- **Registro de entrenamientos**: Añade ejercicios con sets, repeticiones y peso
...
6. Reemplaza las credenciales en `src/services/firebase.ts`
...
4. **Completar datos**: Ajusta sets, repeticiones y peso
...
- Firebase se usa para autenticación y almacenamiento
